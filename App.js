...
import { initializeDefaultServices, getAppointments } from './database';
...
function AppNavigator() {
  ...
  useEffect(() => {
    const setupDatabase = async () => {
      await initializeDefaultServices(); // Inicializa os serviços padrões
    };
    setupDatabase();
  }, []);
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        >
          {props => (
            <TelaInicial {...props} appointments={appointments} setAppointments={handleSetAppointments} />
          )}
        </Stack.Screen>
        <Stack.Screen
          name="AGENDAMENTO"
        ...
        >
          {props => (
            <TelaAgendamentos {...props} appointments={appointments} setAppointments={handleSetAppointments} />
          )}
        </Stack.Screen>
        <Stack.Screen
          name="SERVIÇOS"
